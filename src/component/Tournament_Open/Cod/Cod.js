  ...
  return (
    <div>
      <div className="League_1">
        <Parallax {...parallaxImage3} strength={600} bgImage={Image4}>
        ...
        <div className="League_2">
          <div className="League_3">
            <h1>COD Mobile Daily Tournament 8</h1>
          </div>
          ...
          <div className="League_5">
            ...
            <p className="ends">Registration ends in 28Hours</p>
          </div>
        </div>
        <div className="Main_left_right">
          <div className="League_7">
            <div className="Leagu_div1">
              <img
                className="Image7"
                src="https://kafugames.com/_next/image?url=https%3A%2F%2Fadmin.kafugames.com%2Fuploads%2Fcompetitions%2Fcards%2Fcard1655368919.png&w=1920&q=75"
                alt=""
              />
            ...
            <div className="Leagu_div5">
              <h2 className="About_Game">
                ABOUT COD MOBILE DAILY TOURNAMENT 8
              </h2>
              <a
                className="Flames"
                target="_blank"
              ...
              <ul className="ul">
                <li>• Tournament will be played 6:00PM Saudi Timezone</li>
                <li>
                  • After entering the application, you must go to your friends,
                  and add the opponent via UID Example: 16286868686654
                </li>
                <li>
                  • The player’s UID must match the one in the Tournament table;
                  if Wrong you will be disqualified
                </li>
                <li>
                  • All round:3 Round win condition;Finals:5 rounds win
                  condition
                </li>
                <li>• Game Mode is 1v1</li>
                <li>• MAP:DOCKS</li>
                <li>
              ...
              <ul className="ul">
                <li>• after adding the opponent in your friend list</li>
                <li>• 1)press Multiplayer</li>
                <li>• 2)Press the 3 lines om the Right Cornor</li>
                <li>• 3)Press Private</li>
                <li>• 4)Choose 1v1 Duel</li>
                <li>• 5)choose Map:DOCKS</li>
                <p className="red">6)Match Setting:</p>
                <li>• Round time limit 300sec</li>
                <li>• number of spectators allowed 0</li>
                <li>• 7) invite opponent</li>
                <li>• 8) have fun</li>
              </ul>
