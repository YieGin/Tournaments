  ...
  return (
    <div>
      <div className="League_1">
        <Parallax {...parallaxImage3} strength={600} bgImage={Image3}>
        ...
        <div className="League_2">
          <div className="League_3">
            <h1>FIFA 23 Seasons Playstation 4</h1>
            <h1>Tournament 6</h1>
          </div>
        ...
        <div className="Main_left_right">
          <div className="League_7">
            <div className="Leagu_div1">
              <img
                className="Image7"
                src="https://kafugames.com/_next/image?url=https%3A%2F%2Fadmin.kafugames.com%2Fuploads%2Fcompetitions%2Fcards%2Fcard1646235811.png&w=1920&q=75"
                alt=""
              />
            ...
            <div className="Leagu_div5">
              <h2 className="About_Game">
                ABOUT FIFA 23 SEASONS PLAYSTATION 4
              </h2>
              <a
                className="Flames"
                target="_blank"
              ...
              <ul className="ul">
                ...
                <li>• Gameplay is in Seasons Mode (clubs and teams)</li>
                <li>• The winner is determined from one match</li>
                <li>
                  • The player’s PlayStation ID must match the one in the
                  Tournament table; if Wrong you will be disqualified
                </li>
                <li>
                  • In the event, one of the opponents disconnected in the
                  middle of the game, Create a new Game and continue from where
                  the game stopped(A Screen Shot must be provided From where the
                  game Stopped)
                </li>
                <li>
                  • When no specific time is agreed upon, the game will be
                  played on the official date set by the organizers
                </li>
                <li>• The competitors communicate by PlayStation Only</li>
                <li>
              ...
              <ul className="ul">
                <li>• Game mode: 1V1</li>
                <li>• Game Mode: Seasons</li>
                <li>• Match duration: 12 minutes (6 minutes per half)</li>
                <li>• Game Speed: Normal</li>
                <li>• Squad Type: Online</li>
                <li>
                  • In case of the draw: Extra time and penalties if needed
                </li>
              </ul>
