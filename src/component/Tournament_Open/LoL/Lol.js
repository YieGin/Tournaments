  ...
  return (
    <div>
      <div className="League_1">
        <Parallax {...parallaxImage3} strength={600} bgImage={Image1}>
        ...
        <div className="League_2">
          ...
          <div className="League_5">
            ...
            <p className="ends">Registration ends in 30Hours</p>
          </div>
        </div>
        <div className="Main_left_right">
          <div className="League_7">
            <div className="Leagu_div1">
              <img
                className="Image7"
                src="https://kafugames.com/_next/image?url=https%3A%2F%2Fadmin.kafugames.com%2Fuploads%2Fcompetitions%2Fcards%2Fcard1658241138.png&w=1920&q=75"
                alt=""
              />
            ...
            <div className="Leagu_div5">
              <h2 className="About_Game">
                ABOUT LEAGUE OF LEGENDS 1VS1 DAILY TOURNAMENT 6 CONTACT US
              </h2>
              <a
                className="Flames"
                target="_blank"
              ...
              <ul className="ul">
                <li>• All Rounds: Best of 1; Finals: Best of 3.</li>
                <li>
                  • Each player will ban 3 champions in the private game lobby
                  chat before starting the game
                </li>
                <li>
                  • In case your enemy played one of the banned champions,
                  submit a screenshot to the admin
                </li>
                <li>• Player must be on the Europe West server</li>
                <li>
                  • Having a different Roit ID on Kafu Games will disqualify you
                </li>
                <li>
                  • If your Roit ID has a special character, it is your
                  responsibility to contact your opponent
                </li>
                <li>
                  • Communication between both players is through the League of
                  Legends client
                </li>
                <li>
              ...
              <ul className="ul">
                <li>• Map: ARAM</li>
                <li>• Team Size: 1</li>
                <li>• invite your opponent</li>
                <li>• Game Type: Blind Pick</li>
              </ul>
              <p className="red">Win Condition:</p>
              <ul className="ul">
                <li>1. Get First blood</li>
                <li>2. Get a creep score of 100 (100 cs)</li>
                <li>3. Destroy the first tower</li>
              </ul>
              ...
              <ul className="ul">
                ...
                <li>
                  • If the opponent does not respond, you must register
                  attendance at the official time allotted to the match. (The
                  button appears in your matches list after 15 mins from when
                  the match started)
                </li>
                <li>
